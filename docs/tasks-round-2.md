...
| 9 | DI xuyên suốt service layer | `WalletService` tạo `TransactionService()` nội bộ, `SampleDataService` tạo services trực tiếp. Chuyển sang dùng `sl` hoặc inject qua constructor. | ⬜ |
