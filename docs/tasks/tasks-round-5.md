...
| 11 | Xóa `SampleDataService` truy cập DB trực tiếp | Vẫn dùng `AppDatabase.instance.database` cho batch insert. Cân nhắc chuyển qua repository hoặc giữ nguyên (acceptable cho seed data). | ⬜ |
