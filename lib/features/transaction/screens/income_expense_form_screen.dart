...
class IncomeExpenseFormScreen extends StatefulWidget {
  ...
  const IncomeExpenseFormScreen({super.key, this.walletId, this.existing, this.prefill});

  bool get isEdit => existing != null;

  @override
  State<IncomeExpenseFormScreen> createState() => _IncomeExpenseFormScreenState();
}

class _IncomeExpenseFormScreenState extends State<IncomeExpenseFormScreen> {
