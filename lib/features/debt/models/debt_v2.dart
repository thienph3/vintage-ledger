...
class DebtV2 {
  ...
  factory DebtV2.fromMap(String id, Map<String, dynamic> data) {
    return DebtV2(
      id: id,
  ...
  bool operator ==(Object other) {
    ...
    return other is DebtV2 && other.id == id;
  }
  ...
  @override
  String toString() {
    return 'DebtV2(id: $id, type: $type, party: $partyName, amount: $totalAmount, paid: $paidAmount)';
  }
}