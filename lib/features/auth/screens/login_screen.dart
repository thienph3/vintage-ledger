          ...
          child: Form(
            ...
            child: ListView(
              children: [
                ...
                Text(S.of(context, 'login'), style: AppTextStyles.title, textAlign: TextAlign.center),
                const SizedBox(height: AppSpacing.xl),
                TextFormField(
                ...
                _loading
                    ...
                    : SizedBox(
                        ...
                        child: ElevatedButton(onPressed: _login, child: Text(S.of(context, 'login'))),
                      ),
                const SizedBox(height: AppSpacing.md),
                SizedBox(
                  width: double.infinity,
                  child: OutlinedButton(onPressed: _openRegister, child: Text(S.of(context, 'register'))),
                ),
              ],
            ),
          ),
